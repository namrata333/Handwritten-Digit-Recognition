...
betas = (0.9, 0.999)
''' Create an Optimizer '''
# optimizer = Optimizer_SGD(parameters, learning_rate, momentum) ''' ADAM Optimizer Learning is fast '''
...
else:    print(log._if + "LoadModel CNN Model")
UI.render(ui_callback)
'''test_cnn(net, test_data) evaluate_cnn(net, test_data)
